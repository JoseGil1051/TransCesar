...
public class MenuPasajero{
    ...
    public void RegistrarPasajero(){
        ...
        switch (opcTipo) {
            ...
            default -> {
                System.out.println("Tipo inválido, se asignará REGULAR por defecto.");
                tipo = TipoPasajero.REGULAR;
            }
        }

        boolean exito = pasajeroService.crear(nombre, cedula, tipo);
    ...
    switch (opc) {
        ...
        case 2 -> {
            ...
            List<Pasajero> lista = pasajeroService.buscarPorTipo(tipo); // ← CAMBIADO
            if (lista.isEmpty()) {
